...
import { BackgroundImage, Center, Container, SimpleGrid, Text, Title, UnstyledButton, createStyles, useMantineTheme } from '@mantine/core'
import { VehicleInterface, vehicles } from '@/features/vehicles/static/data'
    ...
    return (
        <main className={classes.main}>
            <Container className={classes.hero} p={0} fluid>
                <BackgroundImage src={vehicle?.hero} style={{ height: '100vh', width: '100vw', backgroundAttachment: 'fixed' }}>
                    <Title className={classes.bigHeading}>
                        {vehicle?.title}
                    </Title>
            ...
            <Container p={0} fluid className={classes.specsSection}>
                ...
                <Container size="xl">
                    <SimpleGrid py={'18vh'} cols={2} breakpoints={[
