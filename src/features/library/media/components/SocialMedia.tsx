...
const useStyles = createStyles((theme) => ({
    wrapper: {
        ...
        backgroundImage: `linear-gradient(120deg, ${theme.colors[theme.primaryColor][4]} 0%, ${theme.colors[theme.primaryColor][7]
            } 100%)`,
    ...
    const icons = iconList.map((Icon, index) => {
        ...
        return (
            <div key={index} className={classes.iconWrapper}>
                <ActionIcon className={classes.iconBtn} ref={ref} size={hovered ? 100 : 50} radius={50} color={Icon.color} variant="filled" component='a' href={Icon.href} target="_blank">
                    <Icon.Icon size={hovered ? 50 : 30} stroke={2} style={{ transition: 'all 200ms ease' }} />
                </ActionIcon>
            </div>
        )
    });
    ...
    return (
        <div className={classes.wrapper}>
            <SimpleGrid cols={2} spacing={50} breakpoints={[{ maxWidth: 'sm', cols: 1 }]}>
                <div>
                    <Title className={classes.title}>Follow us on Social Media!</Title>
                    <Text className={classes.description} mt="sm" mb={30}>
                        Come join us on social media for an exciting dive into the world of underwater robotics, featuring amazing videos, photos, and behind-the-scenes adventures!
                    </Text>
                    <SimpleGrid cols={2}  style={{ justifyItems: 'center' }}>
                        {icons}
                    </SimpleGrid>
                </div>
                <div className={classes.igFeed}>
                    <blockquote className="instagram-media" data-instgrm-permalink="https://www.instagram.com/michiganrobosub/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="14" style={{ background: '#FFF', border: 0, borderRadius: '3px', boxShadow: '0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth: '540px', minWidth: '300px', padding: 0, width: 'calc(100% - 2px)' }}>
                        <div style={{ padding: '16px' }}>
                            <a href="https://www.instagram.com/michiganrobosub/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ background: '#FFFFFF', lineHeight: 0, padding: 0, textAlign: 'center', textDecoration: 'none', width: '100%', }} target="_blank">
                                ...
                                <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '14px', alignItems: 'center' }}><div>
                                    ...
                                    <div style={{ marginLeft: 'auto' }}>
                                        ...
                                        <div style={{ width: 0, height: 0, borderTop: '8px solid #F4F4F4', borderLeft: '8px solid transparent', transform: 'translateY(-4px) translateX(8px)' }}></div></div></div>
                            ...
                            <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                <a href="https://www.instagram.com/michiganrobosub/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank">Michigan Robotic Submarine</a>
                                (@<a href="https://www.instagram.com/michiganrobosub/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: ' Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px' }} target="_blank">michiganrobosub</a>) • Instagram photos and videos
                            </p>
                        </div>
                    </blockquote>
