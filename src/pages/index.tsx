...
import { Container, createStyles, UnstyledButton } from "@mantine/core";
...
export default function Home() {
  ...
  function convertToSpans(text: string) {
    ...
    <main className={classes.main}>
      <Container size="lg" className={`${classes.hero} outer-boi `}>
        ...
        <div className={`${classes.siteTitle} text`}>
          ...
          <p className={classes.tagline + " tagline-animation"}>
            University of Michigan
          </p>
        </div>
        <UnstyledButton
          className={classes.cta + " cta-animation"}
          component={Link}
          href="/about"
        >
          Dive In
